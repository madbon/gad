...
/**
 * This is the model class for table "cms_indicators".
 *
 * @property integer $id
...
class Indicator extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['category_id', 'title', 'is_required'], 'required'],
            [['category_id', 'frequency_id', 'unit_id', 'default_choice_id', 'parent','temp_content_type_id','temp_default_choice','in_chart'], 'integer'],
            [['sort'],'number'],
            ...
            [['type_id'], 'required', 'when' => function($model){
                return $model->temp_content_type_id == '1';
            }, 'whenClient' => 'function(attribute, value){
                return $("#indicator-temp_content_type_id").val() == "1";
            }'],

            [['type_id'], 'required', 'when' => function($model){
                return $model->temp_content_type_id == '2';
            }, 'whenClient' => 'function(attribute, value){
                return $("#indicator-temp_content_type_id").val() == "2";
            }'],

            [['type_id'], 'required', 'when' => function($model){
                return $model->temp_content_type_id == '3';
            }, 'whenClient' => 'function(attribute, value){
                return $("#indicator-temp_content_type_id").val() == "3";
            }'],

            [['type_id'], 'required', 'when' => function($model){
                return $model->temp_content_type_id == '7';
            }, 'whenClient' => 'function(attribute, value){
                return $("#indicator-temp_content_type_id").val() == "7";
            }'],
    ...
    {
        return $this->hasMany(Indicator::className(), ['parent' => 'id'])->andOnCondition(['in','type_id', ['2']])->andOnCondition(['parent' => 157]);
    }
    ...
    {
        return $this->hasMany(Indicator::className(), ['parent' => 'id'])->andOnCondition(['in','type_id', ['2']])->andOnCondition(['parent' => 167]);
    }
