...
/* @var $searchModel common\modules\cms\models\CmsContentWidthSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Content Widths';
// $this->params['breadcrumbs'][] = $this->title;
?>
<div class="cms-content-width-index">
                    ...
                    'buttons'=>[    
                        ...
                        'delete'=>function ($url, $model) {
                            return Html::a('<i class="glyphicon glyphicon-trash"></i> Delete', 
                                [
                                  'cms-content-width/delete', 'id' => $model->id
                                ], 
                                [
