...
<?= Html::a('Create', ['create'], ['class' => 'btn btn-flat btn-success']) ?>
        ...
        <div class="box box-primary">
            ...
            <div class="box-body">  
                ...
                DetailView::widget([
                    ...
                    'attributes' => [
                        ...
                        [
                            ...
                            'value' => $model->is_required == 1 ? 'No':'Yes'
                        ],
                        ['attribute' => 'choices',
                ...
                <?php if($model->unit_id == 7){ ?>
                    <?php if($model->checkSubQuestion == 1) { ?>

                        <h4 class="page-header">Sub-Questions
                        </h4> 

                        <table class="table table-responsive table-bordered table-hover">
                        <tr><th colspan="2"><b style="color:blue; font-size:15  px;">Answer with Sub-Question: <u><?= $model->selectedChoice->answer; ?></u></b></th>
                        </tr>
                        <tr>
                            <th>Sub-Question
                            </th>
                        ...
                        <?php foreach($model->subQuestions as $subquestion) { ?> 
                            <tr>
                                <td><?= $subquestion->sub_question; ?>
                                </td>
                                <td><?= $subquestion->typeTitle; ?>
                                </td>
                            </tr>
                        <?php } ?>
                        </table>
                    ...
                    <div class="form-group pull-right">
                        <?= Html::a('Update', ['update-subquestion', 'id' => $model->id], ['class' => 'btn btn-flat btn-primary']) ?>
                        <?= Html::a('Delete', ['delete', 'id' => $model->id], [
                            'class' => 'btn btn-flat btn-danger',
                            'data' => [
                                'confirm' => 'Are you sure you want to delete this item?',
