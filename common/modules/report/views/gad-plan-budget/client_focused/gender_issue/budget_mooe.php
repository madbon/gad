...
<td id="cell-budget_mooe-<?= $plan['id'] ?>" class="common-cell-container">
    <p><?= $plan["budget_mooe"]?></p>
    <div id="actn-btns-budget_mooe-<?= $plan['id']?>" class="actn-btn-bubble actn-buble-common-class" style="display: none;">
        <button id="btn-select-budget_mooe-<?= $plan['id']?>" type="button" class="btn btn-info btn-xs btn-select-cell" title="Select" >
            Select
        </button>
    </div>
    ...
    <?php
        $this->registerJs('
            $("#cell-budget_mooe-'.$plan["id"].'").mouseover(function(){
                var attr_name = "budget_mooe";
            ...
            $("#btn-select-budget_mooe-'.$plan["id"].'").click(function(){
                var attr_name = "budget_mooe";
    ...
    <!-- button edit and textarea -->
        <button id="btn-edit-budget_mooe-<?= $plan['id']?>" type="button" class="btn btn-primary btn-xs btn-edit-cell" title="Edit"  style="display: none;">
            <span class="glyphicon glyphicon-edit"></span>
        </button>
        <?php
            $this->registerJs('
                $("#btn-edit-budget_mooe-'.$plan["id"].'").click(function(){
                    var attr_name = "budget_mooe";
            ...
            ');
        ?>
        <div id="div-edit-budget_mooe-<?= $plan["id"] ?>" class="bubble div-tooltip-form unik-div-tooltip-form-<?= $plan["id"] ?>">
            <textarea id="txt-edit-budget_mooe" rows="2" class="form-control tooltip-form"></textarea>
    ...
    <!-- button comment and textarea -->
        <button id="btn-comment-budget_mooe-<?= $plan['id'] ?>" type="button" class="btn btn-warning btn-xs btn-comment-cell" title="Comment" style="display: none;">
            <span class="glyphicon glyphicon-comment"></span>
        </button>
        <?php
            $this->registerJs('
                $("#btn-comment-budget_mooe-'.$plan["id"].'").click(function(){
                    var attr_name = "budget_mooe";
                    $(".div-tooltip-form").hide();
            ...
            ');
        ?>
        <div id="div-comment-budget_mooe-<?= $plan["id"] ?>" class="bubble-comment div-tooltip-form unik-div-tooltip-form-<?= $plan["id"] ?>">
            <textarea id="txt-comment-budget_mooe" rows="2" class="form-control tooltip-form" placeholder="Write comment"></textarea>
