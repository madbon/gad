...
<td id="cell-performance_indicator-<?= $plan['id'] ?>" class="common-cell-container">
    <p><?= $plan["performance_indicator"]?></p>
    <div id="actn-btns-performance_indicator-<?= $plan['id']?>" class="actn-btn-bubble actn-buble-common-class" style="display: none;">
        <button id="btn-select-performance_indicator-<?= $plan['id']?>" type="button" class="btn btn-info btn-xs btn-select-cell" title="Select" >
            Select
        </button>
    </div>
    ...
    <?php
        $this->registerJs('
            $("#cell-performance_indicator-'.$plan["id"].'").mouseover(function(){
                var attr_name = "performance_indicator";
            ...
            $("#btn-select-performance_indicator-'.$plan["id"].'").click(function(){
                var attr_name = "performance_indicator";
    ...
    <!-- button edit and textarea -->
        <button id="btn-edit-performance_indicator-<?= $plan['id']?>" type="button" class="btn btn-primary btn-xs btn-edit-cell" title="Edit"  style="display: none;">
            <span class="glyphicon glyphicon-edit"></span>
        </button>
        <?php
            $this->registerJs('
                $("#btn-edit-performance_indicator-'.$plan["id"].'").click(function(){
                    var attr_name = "performance_indicator";
            ...
            ');
        ?>
        <div id="div-edit-performance_indicator-<?= $plan["id"] ?>" class="bubble div-tooltip-form unik-div-tooltip-form-<?= $plan["id"] ?>">
            <textarea id="txt-edit-performance_indicator" rows="2" class="form-control tooltip-form"></textarea>
    ...
    <!-- button comment and textarea -->
        <button id="btn-comment-performance_indicator-<?= $plan['id'] ?>" type="button" class="btn btn-warning btn-xs btn-comment-cell" title="Comment" style="display: none;">
            <span class="glyphicon glyphicon-comment"></span>
        </button>
        <?php
            $this->registerJs('
                $("#btn-comment-performance_indicator-'.$plan["id"].'").click(function(){
                    var attr_name = "performance_indicator";
                    $(".div-tooltip-form").hide();
            ...
            ');
        ?>
        <div id="div-comment-performance_indicator-<?= $plan["id"] ?>" class="bubble-comment div-tooltip-form unik-div-tooltip-form-<?= $plan["id"] ?>">
            <textarea id="txt-comment-performance_indicator" rows="2" class="form-control tooltip-form" placeholder="Write comment"></textarea>
