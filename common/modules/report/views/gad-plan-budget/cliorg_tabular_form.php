...
<?php
    echo $this->render('cell_reusable_form',[
        ...
        'enableEdit' => Yii::$app->user->can('gad_edit_cell') && ($plan["record_status"] == 0 || $plan["record_status"] == 8 || $plan["record_status"] == 9 || $plan["record_status"] == 6 || $plan["record_status"] == 7) ? 'true' : 'false',
