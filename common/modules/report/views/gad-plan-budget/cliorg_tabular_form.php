...
<?php
    echo $this->render('cell_reusable_form',[
        ...
        'enableEdit' => Yii::$app->user->can('gad_edit_cell') && ($plan["record_status"] == 0 || $plan["record_status"] == 7 || $plan["record_status"] == 8 || $plan["record_status"] == 9 || $plan["record_status"] == 11 || $plan["record_status"] == 12 || $plan["record_status"] == 16 || $plan["record_status"] == 20 || $plan["record_status"] == 21) ? 'true' : 'false',
